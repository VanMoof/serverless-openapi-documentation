...
**Using npm:**
```bash
npm install https://github.com/VanMoof/serverless-openapi-documentation.git#latest-commit-hash --save-dev
```

**Using Yarn:**
```bash
yarn add https://github.com/VanMoof/serverless-openapi-documentation.git#latest-commit-hash --dev
```
...
```yml
plugins:
  - @vanmoof/serverless-openapi-documentation
```
